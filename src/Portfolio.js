...
const Portfolio = () => {
    ...
    return ( 
        ...
        id="portfolio" className="Portfolio">
            ...
            <p style={{color:darkMode ? "#00090E":"#B3CCFF"}} className='font-extrabold'>PORTFOLIO </p>
          ...
          <AnimatePresence>
            ...
            <motion.div 
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-14 sm:gap-8 justify-center items-center mt-16">
                        <div style={{width:"500px"}} class="card3">
                        ...
                        <div class="second-content flex flex-col items-center justify-start">
                        <span style={{color:"#00090E"}} className="font-extrabold">Facebook</span>
                        <p style={{color:"#00324d"}} className="font-bold text-sm mt-4">
                          The very first project where i learned basic of HTML & CSS , after that i wanted to apply all i learned into a clone log in form of facebook
                        </p>
                        <div className="flex mt-8 gap-4">
                            <div className="flex flex-col items-center">
                            <svg
                        ...
                        <div className="flex mt-8 gap-4">
                            ...
                            initial={{scale:1}}
                            whileHover={{scale:1.1 ,transition:1 ,delay:0.5}}
                            className="flex gap-2" href="https://github.com/EnisZekiqi/Facebook-Project" target="_blank" rel="noopener noreferrer">
                            <svg
                                viewBox="0 0 1024 1024"
                                fill="#00090E"
                                height="25px"
                ...
                <AnimatePresence>
                    ...
                    >
                        ...
                        <span style={{color:"#00090E"}} className="font-extrabold">Kasamil</span>
                        <p style={{color:"#00324d"}} className="font-bold text-sm mt-4">
                           This project was more challenging as i learned Bootstrap and started making responsive designs , added more colors and more design styles
                        </p>
                        <div className="flex mt-8 gap-4">
                            <div className="flex flex-col items-center">
                            <svg
