           ...
           >
            <p>zeka</p>
                ...
                <AnimatePresence>
                    ...
                    <motion.div
                    initial={{scale:0,opacity:0}}
                    animate={{scale:1,opacity:1 , duration:1,delay:0.5}}
                    exit={{scale:0,opacity:1, duration:1,delay:0.5}}
                    className="mt-16"
                    >
                    <div className="flex">
                    <div class="card">
                        ...
                        <p style={{color:"#00090E"}} className="font-bold text-sm mt-4">
            ...
            <button>
            <a href="https://h593h5-3000.csb.app/" target="_blank" rel="noopener noreferrer">
                Show
            </a>
            </button>
